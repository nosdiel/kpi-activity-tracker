...
const withFY2027 = (rows: FY[] = []) => {
  ...
  // Anchor FY2027 at a known start (or derive from FY2026 if present).
  if (!map.has(2027)) {
    const fy2026 = map.get(2026);
    map.set(2027, fy2026 ? shiftISODate(fy2026, 364) : "2026-12-27");
  }
  // Back-fill prior fiscal years (down to 2020) by stepping back 364 days
  // so the dashboard can default to the FY containing today even when
  // fiscal_year_settings hasn't been populated yet.
