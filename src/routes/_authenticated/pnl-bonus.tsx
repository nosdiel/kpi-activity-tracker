...
export const Route = createFileRoute("/_authenticated/pnl-bonus")({
  head: () => ({ meta: [{ title: "Pnl Bonus — NiNi KPI" }] }),
  component: pnl_bonusPage,
});

function pnl_bonusPage() {
  return (
    <div className="space-y-6">
      <div>
        <p className="text-sm uppercase tracking-[0.2em] text-muted-foreground">NiNi - KPI</p>
        <h1 className="text-3xl font-bold tracking-tight text-foreground">Pnl Bonus</h1>
      </div>
      <Card>
        <CardHeader>
          <CardTitle>Pnl Bonus</CardTitle>
